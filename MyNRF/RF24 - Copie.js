...
*/
            var result = "";
            var statusRdy = 0;
            spi.transfer(buf1, new Buffer(buf1.length), function (device, bufRes) {
                result = bufRes[0];
                for (var i = 1; i < bufRes.length; i++) {
                    buf[i - 1] = bufRes[i];
                }
